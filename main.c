...
// Our protocol GUID (should be different for every driver) a83d068b-5240-4e4c-a62f-c81e35b7a3a0
static const EFI_GUID ProtocolGuid
	= { 0x859db974, 0xaff9, 0x4eb0, {0xa9f2, 0x10, 0xe6, 0x0d, 0x80, 0x36, 0x94, 0xf1} };

// VirtualAddressMap GUID (gEfiEventVirtualAddressChangeGuid)
static const EFI_GUID VirtualGuid
	= { 0x7a12e8b0, 0xe898, 0x4466, { 0x81, 0x82, 0x22, 0xf3, 0x99, 0x1a, 0x03, 0x86 }}; //we will remove later shouldn't be important

// ExitBootServices GUID (gEfiEventExitBootServicesGuid)
static const EFI_GUID ExitGuid
	= { 0xa83d068b, 0x5240, 0x4e4c, { 0xa6, 0x2f, 0xc8, 0x1e, 0x35, 0xb7, 0xa3, 0xa0 }}; //we will remove later shouldn't be important
